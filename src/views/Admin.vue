...
<div class="container">
  ...
  <div class="row mt-3 text-center">
    <div class="col-md-8 offset-md-2">
      ...
      <!-- Minter: changePrice - 6char -->
      <div v-if="isUserMinterAdmin">
        <h3>Change price (6+ char domains)</h3>

        <p>Current price: {{getMinterTldPrice6}} ETH</p>
        ...
        <div class="row mt-5">
          <div class="col-md-6 offset-md-3">
            <input 
              v-model="newPrice6"
              class="form-control text-center border-2 border-light"
              placeholder="Enter the new price for 6+ char domains"
            >
          </div>
        </div>
        ...
        <button 
          ...
          class="btn btn-primary btn-lg mt-3" 
          @click="changePrice(6)" 
          :disabled="waitingPrice6"
        >
          <span v-if="waitingPrice6" class="spinner-border spinner-border-sm mx-1" role="status" aria-hidden="true"></span>
          <span>Change price (6+ chars)</span>
        </button>

        <hr />
      </div>
      <!-- END Minter: changePrice - 6char -->
...
export default {
  ...
  data() {
    return {
      ...
      waitingPrice6: false, // waiting for TX to complete
    ...
    async changePrice(chars) {
      ...
      switch(chars) {
        ...
        case 5:
          ...
          break;
        case 6:
          this.waitingPrice6 = true;
          newPrice = this.newPrice6;
          break;
      }
